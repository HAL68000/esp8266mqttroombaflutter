...
const char *mqtt_user = "YOUR_MQTT_USERNAME"; //I didn't used any login or password in this example 
...
void reconnect() 
{
  ...
  while (!client.connected()) 
  {
    ...
    {
      // Attempt to connect
      if (client.connect(mqtt_client_name, "roomba/status", 0, 0, "Dead Somewhere")) 
      {
...
void stopPower()
{
  ...
  delay(50);
  Serial.write(133);
  client.publish("roomba/status", "Power off");
}
